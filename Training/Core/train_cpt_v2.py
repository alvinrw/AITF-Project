...
Jalankan: nohup python train_cpt.py > training.log 2>&1 &
"""
import os
import gc
import math
...
# Path dataset (home directory)
HOME            = os.path.expanduser('~')
JSONL_FILE      = os.path.join(HOME, 'Testing', 'Data', 'data_training_mixed.jsonl')
checkpoint_path = os.path.join(HOME, 'Testing', 'checkpoints', 'qwen_cpt_05b_v2')
output_path     = os.path.join(HOME, 'Testing', 'output', 'qwen_cpt_05b_v2_final')
OUTPUT_DIR      = checkpoint_path

WANDB_PROJECT   = "AITF - CPT"
WANDB_RUN_NAME  = "Qwen2.5-0.5B-AITF-CPT-v2-Aggressive"
# ============================================================
...
training_args = TrainingArguments(
    ...
    warmup_steps                = 120,
    num_train_epochs            = 3,        # 📈 NAIK: dari 1 jadi 3 putaran!
    learning_rate               = 5e-5,     # 📈 NAIK: dari 1e-5 jadi 5e-5!
