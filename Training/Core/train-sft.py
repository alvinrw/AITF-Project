...
def parse_args():
    parser = argparse.ArgumentParser(
        description="SFT Training Qwen2.5-0.5B-AITF-V2 dari model CPT lokal",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    # Path arguments
    parser.add_argument("--cpt-model-path", type=str,
                       default="/home/jovyan/Testing/output/qwen_cpt_05b_v2_final",
    ...
    parser.add_argument("--output-dir", type=str,
                        default="/home/jovyan/Testing/output/sft_qwen_05b-V2_final",
...
def main():
    ...
    WANDB_RUN_NAME = f"qwen2.5-0.5b-cpt-sft-V2JOSS-{datetime.now():%Y%m%d-%H%M}"
    ...
    train_result = trainer.train(
        resume_from_checkpoint="/home/jovyan/Testing/output/sft_qwen_05b-V2_final/checkpoint-16875"
    )
